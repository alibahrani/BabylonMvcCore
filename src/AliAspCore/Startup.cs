...
namespace AliAspCore
{
    public class Startup
    {
        ...
        {
            services.AddTransient<SpeciaDataContext>();
            ...
            services.AddDbContext<SpeciaDataContext>(options => {
                var connectionString = configuration.GetConnectionString("SpeciaDataContext");
                options.UseSqlServer(connectionString);
            });
